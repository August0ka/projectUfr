    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="app/consult/index.php">Consultas</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="app/patients/index.php">Pacientes</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="app/doctors/index.php">Médicos</a>
          </li>  
          <li class="nav-item">
